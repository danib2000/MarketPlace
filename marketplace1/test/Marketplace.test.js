...
const Marketplace = artifacts.require('./MarketPlace2.sol')
require('chai')
...
contract('MarketPlace', ([deployer, seller, buyer]) => {
    ...
    describe('deployment', async() =>{
        ...
        it('has a name', async () => {
            ...
            assert.equal(name, 'MarketPlace2')
          })
    ...
    describe('products', async() =>{
        ...
        before(async () => {
            result = await mp.createProducts("iPhone X", web3.utils.toWei('1', 'Ether'),3, {from: seller})
        ...
        it('creates products', async () => {
            ...
            assert.equal(product.stock, '3','stock is correct')
